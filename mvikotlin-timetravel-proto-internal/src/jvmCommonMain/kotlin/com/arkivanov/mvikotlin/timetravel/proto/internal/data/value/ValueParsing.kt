...
import com.arkivanov.mvikotlin.timetravel.proto.internal.utils.canAccessCompat
import com.arkivanov.mvikotlin.timetravel.proto.internal.utils.trySetAccessibleCompat
...
private fun otherDefault(obj: Any, visitedObjects: MutableSet<Any>): ParsedValue.Object.Other {
    ...
    obj.javaClass.allFields.forEach { field ->
        if (field.isValidForParsing()) {
            val isAccessible = field.canAccessCompat(obj)
